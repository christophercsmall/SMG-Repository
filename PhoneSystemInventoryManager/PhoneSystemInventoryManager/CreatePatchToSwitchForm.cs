...
{
    public partial class CreatePatchToSwitchForm : Form
    {        
        ...
        public CreatePatchToSwitchForm(MainForm mainForm)
        {            
            InitializeComponent();
            mf = mainForm;
        }
        ...
        {            
            ...
            List<int> switchPortNumListToInt = new List<int>();

            fs.swpFilteredList = switchPortFilteredList;

            foreach (SwitchPort swp in switchPortFilteredList)
            {
                switchPortNumListToInt.Add(swp.switchPortNum);
            }

            switchPortNumListToInt.Sort();
            switchPortNumList = switchPortNumListToInt.ConvertAll<string>(x => x.ToString());
        ...
        {            
            if (switchPortBox.Enabled && PPPortBox.Enabled)
            {
